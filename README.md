# `angular-tutorial` — A branch from the Angular Seed

I'm not going to write a huge paragraph here.  I've done some Angular work before, but it was messy.  Too messy.

I don't like messy, so I'm doing the tutorial to learn how to make sure it's not messy.
Initially, other code and the tutorial was used as a reference.  Not this time.  

The tutorial shall be the teacher and I shall learn from it like I should have originally.

--

Everything below is from the angular-seed repo. 
## Getting Started
